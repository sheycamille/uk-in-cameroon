...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{asset('app/assets/images/icon/favicon.ico')}}">
    ...
    <link rel="stylesheet" href="{{asset('app/css/metisMenu.css')}}">
    ...
    <!-- others css -->
    <link rel="stylesheet" href="{{asset('app/css/typography.css')}}">
    <link rel="stylesheet" href="{{asset('app/css/default-css.css')}}">
...
<body>
    ...
    <div class="page-container">
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyrights | UK - Cameroon TradeHub. built by <a href="https://colorlib.com/wp/">AS solutions</a>.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
    ...
    <script src="{{asset('app/js/vendor/jquery-2.2.4.min.js')}}"></script>
    <!-- bootstrap 4 js -->
    <script src="{{asset('app/js/popper.min.js')}}"></script>
    <script src="{{asset('app/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('app/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('app/js/metisMenu.min.js')}}"></script>
    <script src="{{asset('app/js/jquery.slimscroll.min.js')}}"></script>
    ...
    <!-- all pie chart -->
    <script src="{{asset('app/js/pie-chart.js')}}"></script>
    <!-- others plugins -->
